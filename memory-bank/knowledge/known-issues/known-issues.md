...
title: "已知问题合辑 (已拆分)"
description: "KI-001–KI-006 原始合辑，已拆分为独立文件。"
tags:
  - known-issue
  - archive
  - reference
...
**参考**：[`deployment-runbook §21.3.1`](./manuals/deployment-runbook-ubuntu-2404.md)
...
| Playwright UAT | **待重跑** | `test:e2e:workflow-video-uat`；见 `progress.md`「E2E 待办」 |
...
**基线 ID**: `2026-06-22-main-e2e-core-33`（见 `progress.md`「测试基线」与「E2E 待办」）
