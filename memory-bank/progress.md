...
| IA-3 / UI Phase D（汇报中心） | done | Master-Detail + ReportComposeDrawer；见 commit 待填。 |
| IA-4 / UI Phase E（组织管理） | pending | 人员 Drawer + 部门树；见 [`ui-refactor-spec-v2.md`](plans/ui-refactor-spec-v2.md) §8。 |
