...
| **阶段** | **主开发线 F-05 + 人工 UAT 等待** — `v0.93.0-rc.1` 保持为员工试用基线；详情数据协调拆分完成，I4/设计器/S-01 等待人工 UAT，I3-F 生产切流仍 gated |
| **最后整理** | 2026-08-10 — F-05 首批详情数据协调完成，KI-011 继续延后 |
...
4. **隔离员工 RC**：从不可变 `v0.93.0-rc.1` 部署并核对 health version；只将 P0/P1 修复回流 RC，普通主线功能不移动标签。
