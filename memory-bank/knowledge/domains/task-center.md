...
> **最后同步**：2026-08-11 @ **v0.93.0-rc.2 / main** · 模板可见性热修回流；F-05 数据协调完成、动作协调待拆
...
| **架构债** | ⏳ | Legacy E 历史表族清理；**F-05** Shell 拆分首批完成（数据协调已提取，当前约 1,895 行；动作与板块仍待拆） |
...
| F-05 | 壳层 | Shell 拆分 | **首批数据协调 ✅；动作与资料/评论待拆** | P0 |
