...
本文件为 UI 重构里程碑总览；**IA-0…IA-5（Phase A–F）已于 2026-05 交付**，细节见 [`ui-refactor-spec-v2.md`](./ui-refactor-spec-v2.md) 与用户说明书 [`handbooks/user-manual.md`](../handbooks/user-manual.md) v1.1。
