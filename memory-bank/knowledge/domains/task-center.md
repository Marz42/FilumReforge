...
> **最后同步**：2026-08-12 @ **v0.93.0-rc.2 / main** · F-05 全部完成；主开发线进入 Iteration 5-A 投影契约
...
| **架构债** | ⏳ | Legacy E 历史表族清理；**F-05 已完成**，Shell 约 1,989 → 838 行；Task Center 动态 graph-first 拼装转入 Iteration 5 投影主线 |
...
| F-05 | 壳层 | Shell 拆分 | **数据协调 ✅；动作协调 ✅；资料/评论 ✅；活动时间线 ✅；工作流展示/遥测 ✅；已完成** | done |
