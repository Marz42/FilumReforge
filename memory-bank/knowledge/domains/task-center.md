...
> **最后同步**：2026-08-11 @ **v0.93.0-rc.2 / main** · F-05 数据与动作协调两批完成，资料/评论板块待拆
...
| **架构债** | ⏳ | Legacy E 历史表族清理；**F-05** 数据/动作协调已提取，Shell 约 1,569 行；资料附件与评论/留痕板块待拆 |
...
| F-05 | 壳层 | Shell 拆分 | **数据协调 ✅；动作协调 ✅；资料/评论待拆** | P0 |
