...
| **当前阶段** | 正式运营基线已交付；**任务中心增强（TCE）Phase 1** 就绪实施 @ `0.89.0` |
...
| **任务中心增强**（读模型、性能、统计、多部门模板） | **进行中** — [`plans/task-center-enhance.md`](./plans/task-center-enhance.md) |
| 公开 / 审批式注册 | 待产品决策 |
| 工作流 E 与图引擎产品级统一 | **TCE Phase 5 / TC-P3** |
