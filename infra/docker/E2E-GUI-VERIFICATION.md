...
具体命令与需落库的文件清单见 [memory-bank/knowledge/manuals/e2e-gui-verification-automation-runbook.md](../../memory-bank/knowledge/manuals/e2e-gui-verification-automation-runbook.md)。  
...
| #   | 步骤                                                                          | 通过  |
| --- | --------------------------------------------------------------------------- | --- |
| B1  | L4 访问 `/departments`、`/people` 应无菜单或 403/重定向                                | [X] |
| B2  | L1 访问 `/departments` 应拒访                                                    | [X] |
| B3  | L0 在 `/departments` 可查看部门树（总部 → 人力运营中心 / 技术中心 / 客户成功部 / 财务行政部；技术中心 → 平台研发组） | [X] |
...
| C1.2b | 任务资料附件  | **L4** 在任务详情「任务资料附件」上传允许类型（如 PNG）→ 列表出现 → 可「查看/下载」                                                               | [ ] |
