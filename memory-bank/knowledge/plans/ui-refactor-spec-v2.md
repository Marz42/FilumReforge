...
paradigma:
  relations:
    related_to:
      ...
      - ui-information-architecture-plan.md
...
文档同步：`infra/docker/E2E-GUI-VERIFICATION.md`、`knowledge/manuals/e2e-gui-verification-automation-runbook.md`。
