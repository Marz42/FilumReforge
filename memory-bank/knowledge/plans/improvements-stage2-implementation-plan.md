...
5. Phase 4 / 消息中心深化
6. Phase 5 / 注册与账号开通
7. Phase 6 / 部署演练与全量回归 — **done**（2026-05-21）
...
2. 按 `memory-bank/knowledge/manuals/deployment-runbook-ubuntu-2404.md` 做一次完整部署演练。
3. 固化回滚步骤与最小恢复路径。
...
| 主题 | 说明 | 建议依赖/备注 |
| --- | --- | --- |
| Ubuntu 最小回滚演练 | git 回退 + systemd 重启；可选 Phase 11-E 迁移 rollback dry-run | 补 Stage 2 Phase 6 遗留 |
