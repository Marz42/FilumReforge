...
type: paradigma-plan
title: "TCE 增强计划"
description: "任务中心 TCE Phase 1–5 实施计划。"
tags:
  - plan
  - TCE
...
> **状态 @ `0.90.0`**：**已落地** — B-16 / F-17（实例部门优先 + 发起部门 UI）· F-28（fork 时 copywriters = 发起部门）。`--copy-dept-code` 仅默认文案池；A/B 共用一套模板，实例化选发起部门。
...
### 6.1 原状（2026-06-21 审查；**已由 Phase 4 + F-28 解决**）
