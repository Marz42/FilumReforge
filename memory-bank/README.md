...
> **当前实施焦点**：[`active-task.md`](./runtime/active-task.md) → F-05 已完成，主开发线进入 [Iteration 5-A 投影契约与加法迁移](./knowledge/plans/2026-08-12-iteration5a-projection-contract-plan.md)；其后按 [Iteration 5 → 稳定观察 → Iteration 6](./knowledge/plans/2026-08-11-f05-iteration5-6-sequencing-plan.md) 推进。`v0.93.0-rc.2` 等待员工复测，生产准入仍独立推进 · [计划状态目录](./knowledge/plans/plan-status-catalog.md) · [UAT 清单](./knowledge/manuals/2026-08-09-iteration4-domain-neutral-designer-uat-checklist.md) · [上线清单](./knowledge/manuals/2026-08-09-production-release-checklist.md)
