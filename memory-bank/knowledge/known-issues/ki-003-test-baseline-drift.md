...
| frontend current main | **68 files / 191 tests PASS** @ 2026-08-11 | RC2 修复回流后 type-check PASS |
...
**本地单元基线 ID**: `2026-08-11-rc2-main-forward-port`；浏览器 E2E 最近完整基线为 `2026-08-09-v0.93.0-rc.1-release-candidate`，RC2/当前主线仍待目标环境刷新。
