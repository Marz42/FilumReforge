...
paradigma:
  relations:
    related_to:
      - ../manuals/workflow-video-v1-docker-runbook.md
      - ../manuals/workflow-video-v1-multi-account-e2e-guide.md
...
| W6-5 | Runbook：Docker 复现 | [workflow-video-v1-docker-runbook.md](../manuals/workflow-video-v1-docker-runbook.md) |
...
| W10-5 | 多账号 Live/Mock E2E（A–F） | `workflow-video-multi-account-live.spec.ts` + mock spec；指南 [`workflow-video-v1-multi-account-e2e-guide.md`](../manuals/workflow-video-v1-multi-account-e2e-guide.md) | done |
