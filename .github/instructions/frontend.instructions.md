...
- 先读 [memory-bank/architecture.md](../../memory-bank/architecture.md) 和 [memory-bank/design-document.md](../../memory-bank/design-document.md)；需要确认当前界面主线或工作流 E 边界时，再看 [memory-bank/progress.md](../../memory-bank/progress.md) 与 [memory-bank/implementation-plan.md](../../memory-bank/implementation-plan.md)。
