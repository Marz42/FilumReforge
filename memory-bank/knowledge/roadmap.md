...
| **阶段** | **主开发线 UAT 闭环** — `v0.93.0-rc.1` 保持为员工试用基线；模板治理与验收准备已实现，I4/设计器/S-01 等待人工 UAT，I3-F 生产切流仍 gated |
| **最后整理** | 2026-08-10 — Iteration 4 验收准备检查完成，KI-011 继续延后 |
...
**下一 actionable**：把当前主线部署到开发/预发环境，依次执行“数据检查”→“验收准备”→人工 UAT checklist；只有清单必测项完成并签字，才把 I4/设计器/S-01 改为 UAT 通过。RC 试用和生产准入继续按各自清单独立推进。
