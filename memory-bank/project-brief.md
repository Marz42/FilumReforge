...
| 公开 / 审批式注册 | 待产品决策 |
| 工作流 E 与图引擎产品级统一 | **P0 B-12** — 移除 Legacy E runtime，仅图引擎（ADR-009 G-05） |
| 单步任务创建抄送 | **P1 F-22**（G-04） |
| 任务流多部门 copywriters 池 | **P1 F-28**（N4/N12 须跟发起部门） |
| 跨部门单步路由 | **P2 F-21**（G-01）；远期 **项目组 P4**（G-02） |
| 通用模板链 + 防环 | **P2 F-23**（ADR-010） |
