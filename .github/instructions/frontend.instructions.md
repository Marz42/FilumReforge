...
- 先读 [`active-task.md`](../../memory-bank/runtime/active-task.md)、[`knowledge/index.md`](../../memory-bank/knowledge/index.md)、[`project-brief.md`](../../memory-bank/knowledge/project-brief.md)、[`architecture.md`](../../memory-bank/knowledge/architecture.md)；需要确认界面主线时，再看最近 session log 与 [`implementation-plan.md`](../../memory-bank/knowledge/plans/implementation-plan.md)。涉及 UI 时将根 [`DESIGN.md`](../../DESIGN.md) 作为 WARM 参考；模板仍为空白时以既有组件和界面事实为准，不臆造 tokens。
