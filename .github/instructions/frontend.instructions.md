...
- 先读 [`memory-bank/project-brief.md`](../../memory-bank/project-brief.md)、[`architecture.md`](../../memory-bank/architecture.md)；需要确认界面主线时，再看 [`active-task.md`](../../memory-bank/active-task.md) 与 [`plans/implementation-plan.md`](../../memory-bank/plans/implementation-plan.md)。
