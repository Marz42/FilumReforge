...
title: "视频 Docker 冒烟手册"
description: "视频工作流 v1 Docker 冒烟。"
tags:
  - manual
  - 视频
  - Docker
...
**多文案部 + 一后期部**：只需 **一套** `topic_meeting_batch_v1` / `video_production_per_topic_v1`；`--copy-dept-code` 任选其一作默认文案池，实例化时选「发起部门」（文案 A 或 B）。详见 [deployment-runbook §21.3.1](../manuals/deployment-runbook-ubuntu-2404.md)。
