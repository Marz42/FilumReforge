...
- 5-A revision 为 `20260812_01`；5-B 追加 checkpoint，5-C 追加 shadow observation 与 BIGINT 修正，5-D 追加运维审计与 trace 后仓库单 head 已前移至 `20260812_04`。PostgreSQL 增量离线 SQL均可生成。
