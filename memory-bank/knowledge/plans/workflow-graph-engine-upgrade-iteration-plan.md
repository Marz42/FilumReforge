...
> **状态**：Iteration 0–4、F-05 与 Iteration 5-A/B 工程实现已完成；Iteration 3-F 目标环境 7 天观测、31 项最终批准和 5-A/B PostgreSQL 迁移证据未完成，生产切流继续 blocked。下一开发批为 5-C 影子比较，再建设运维能力；稳定观察和单独批准后才进入 Iteration 6。正式顺序见 [`2026-08-11-f05-iteration5-6-sequencing-plan.md`](./2026-08-11-f05-iteration5-6-sequencing-plan.md)。
