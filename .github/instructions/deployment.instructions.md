...
- 先区分开发与生产路径：开发 / 集成联调用 [infra/docker/docker-compose.yml](../../infra/docker/docker-compose.yml)，生产 Compose 用 [infra/docker/docker-compose.prod.yml](../../infra/docker/docker-compose.prod.yml)，主机部署参考 [memory-bank/deployment-runbook-ubuntu-2404.md](../../memory-bank/deployment-runbook-ubuntu-2404.md)。
...
- Compose、Nginx 和部署文档的细节优先链接 [infra/docker/README.md](../../infra/docker/README.md) 与 [memory-bank/deployment-runbook-ubuntu-2404.md](../../memory-bank/deployment-runbook-ubuntu-2404.md)，不要在 instruction 里复制整段操作手册。