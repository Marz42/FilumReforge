...
| 字段 | 内容 |
|------|------|
| **当前版本** | `0.90.0`（根目录 `VERSION`） |
| **版本主题** | TC-Transform Phase 0–2 + F-24/F-25 · 内测部署 |
| **阶段** | **内测验收** — Phase 0–3 能力已落地 |
| **最后整理** | 2026-06-23 — `19608f0` 生产 seed 修复 |
...
**下一 actionable**：**内测部署验收**（[`deployment-runbook §21`](./handbooks/deployment-runbook-ubuntu-2404.md)）；**S-01** 待立项。
